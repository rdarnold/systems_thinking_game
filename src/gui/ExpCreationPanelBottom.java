...
public class ExpCreationPanelBottom extends PanelBottomBase {

    ExpCreationPanelSet m_ParentPanelSet;
    
    private ExpCreationPanelBottom thisScreen;

    public ExpCreationPanelBottom(ExpCreationPanelSet panelSet) {
        super();
        thisScreen = this;
    ...
    private void create() {
        ...
        btn.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                m_ParentPanelSet.onCreateButton(thisScreen.className());
            }
        });
        getChildren().add(btn);
