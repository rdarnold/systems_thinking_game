...
// Gos - Game of Systems
public class InfoScreen extends GosSceneBase {
    ...
    private InfoScreen thisScreen;

    public InfoScreen(Gos theGos, BorderPane root, int wid, int hgt) {
    ...
    public void updateHelperText() {
        String text = "Information\nThis section provides general information on " +
            "different parts of the game.  It is meant to be used as a reference and " +
            "can help to familiarize with how the game works.";
