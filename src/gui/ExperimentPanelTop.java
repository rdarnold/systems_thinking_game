...
public class ExperimentPanelTop extends PanelTopBase {

    ExperimentPanelSet m_ParentPanelSet;
    Label instructionText;
    
    private ExperimentPanelTop thisScreen;

    public ExperimentPanelTop(ExperimentPanelSet panelSet) {
        super();
        thisScreen = this;
    ...
    private void create() {
        getInfoArea().setName("Experiment Screen");
