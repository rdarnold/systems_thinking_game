...
public class GameDataItem {
    ...
    private final IntegerProperty displayId = new SimpleIntegerProperty(0); // For display purposes
    ...
    public void setDisplayId(int num) {
        displayId.set(num);
    }

    public IntegerProperty displayIdProperty() {
        return displayId;
    }
